    ...
    <BrowserRouter>
      <>
        <Routes>
          ...
          <Route path="/admin/*" element={<PrivateRoute role={ROLE_ADMIN} element={AdminPage} />} />
          <Route path="/hd/*" element={<PrivateRoute role={ROLE_HEADOFDEPLOYMENT} element={HeadOfDeploymentPage} />} />
          <Route path="/fd/*" element={<PrivateRoute role={ROLE_FUELDISTRUBTOR} element={FuelDistrubtorPage} />} />
          <Route path="/driver/*" element={<PrivateRoute role={ROLE_DRIVER} element={DriverPage} />} />
          <Route path="/employee/*" element={<PrivateRoute role={ROLE_EMPLOYEE} element={EmployeePage} />} />
          <Route path="/director/*" element={<PrivateRoute role={ROLE_DIRECTOR} element={DirectorPage} />} />

          <Route path="/mechanic/*" element={<PrivateRoute role={ROLE_MECHANIC} element={MechanicPage} />} />
          <Route path="/gd/*" element={<PrivateRoute role={ROLE_GARAGEDIRECTOR} element={GarageDirectorPag} />} />
          <Route path="/vp/*" element={<PrivateRoute role={ROLE_VICEPRESIDENT} element={VicePresidentPage} />} />
          <Route path="/store/*" element={<PrivateRoute role={ROLE_STORE} element={StorePage} />} />
          <Route path="/guard/*" element={<PrivateRoute role={ROLE_GUARD} element={GuardPage} />} />
        </Routes>
      </>
      <Footer />
    </BrowserRouter>
