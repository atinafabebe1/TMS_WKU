  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="vehicles/edit-vehicle/:id" element={<EditVehicleRecord />} />
        ...
        <Route path="vehicles/detail/:id" element={<SingleVehicleDetailInfoo />} />
        <Route path="vehicles/Assign" element={<AssignVehicle />} />
        <Route path="complain" element={<Complain />} />
        <Route path="request/maintenance" element={<HODMaintenanceRequestPage link={`/Request/maintenance`} />} />
