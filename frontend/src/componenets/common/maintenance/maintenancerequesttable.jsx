      ...
      <Modal show={showModal} onHide={handleModalClose}>
        ...
        <Modal.Body>
          <p>
            ...
            <strong>{selectedRequest?.plateNumber}</strong>
          </p>
          <p>
          ...
          <p>
            <strong className="form-control-custom">
              Kilometer On Counter:{" "}
            </strong>
            <strong>{selectedRequest?.kilometerOnCounter}</strong>
          </p>
          <p>
          ...
          {selectedRequest?.status === "canceled" && (
            <p>
              <strong className="form-control-custom">Rejection Reason:</strong>{" "}
